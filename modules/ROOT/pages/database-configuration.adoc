...
Download the driver compatible with Oracle 12.2.0.1: https://www.oracle.com/database/technologies/jdbc-ucp-122-downloads.html[ojdbc8.jar] ( make sure it is the offical driver by checking the SHA1 Checksum: 60f439fd01536508df32658d0a416c49ac6f07fb )
